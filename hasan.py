...
def banner():
 ...
 ═══════════.         lllllllllllllllllllllllll         cccccccccc
 llllllllllllllllllllllllllllllllll.             llllllllll.             cc
    ║lllllllllllllllllllll.                llllll.               cc
    ║lllllllll.                       lll.                 cc
    ║lll.                          ll.                  ccccccccc

╔═════════════════════════════════════════╗
║ Creator     : FTC   
║ Fasebook  : moaide altrhone
║l Number    : 0945135948                     
║ FILENAME  : FTC          
╚══════════════════════════════════════════╝
...
def chk():
  ...
  try: 
    httpCaht = requests.get("https://pastebin.com/raw/BxCR5Arf").text 
    if id in httpCaht: 
